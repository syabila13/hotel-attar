...
<body class="img js-fullheight" style="background-image: url(/login/images/hotel1.jpg);">
			...
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-4">
					<div class="login-wrap p-0">
						<h3 class="mb-4 text-center">sudah punya
							akun?</h3>
						<form action="/petugas/login" method="post" class="signin-form">
